...
<Video src="bestBeginnerVideos.mentalModels" title="A guide to the mental models behind Logseq" />
...
{/* TODO(dario): the live page repeats the previous paragraph verbatim here.
    Looks like a copy-paste mistake on the source site. Decide whether to
    keep it as-is for parity, or rewrite. */}
